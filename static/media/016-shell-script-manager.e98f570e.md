...
**Demo Video.** We will be demonstrating the following in the demo video:

- How shell scripts are ***grouped***, ***managed*** and executed
- How markdowns are ***displayed*** and ***edited***
- Our application states is managed ***by spring boot*** launched at a random port (you can see a swagger document generated)
- On closing the application, the server gets ***shut down first*** (a refresh of the API doc page returns 404).
