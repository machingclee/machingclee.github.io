...
import com.billie.application.events.DummyEvent
import com.billie.payment.application.commands.DummyCommand
...
```kotlin
package com.billie.payment.application.commands
...
```kotlin
package com.billie.application.events
...
```kotlin
package com.billie.payment.application.event
...
```kotlin
package com.billie.restapi.config
