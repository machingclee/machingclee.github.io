...
```
To solve it we following the instruction from sectoin ***3.1.3. Installing zlib*** from <a href="https://docs.nvidia.com/deeplearning/cudnn/install-guide/index.html#install-zlib-windows">here</a>.
