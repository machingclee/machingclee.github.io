...
Since I have understood the model thoroughly, I created another dataset pipeline for rust detection, and the result is pretty well:

- [Demonstration and Explaination of the Work](https://youtu.be/013QXBFrXnQ?t=428)
