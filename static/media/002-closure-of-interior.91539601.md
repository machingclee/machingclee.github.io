...
***Proof.*** For every $x_1\in [x_0,x)$, there is a $\delta>1$ such that $x = x_0 + \delta(x_1-x_0)$.  Let $\rho>0$ be such that $B(x_0,\rho)\subseteq U$.
...
***Proof.*** The direction $\overline{C^\circ}\subseteq \overline C$ is clear. 
