...
But when there are too many titles, for example: in <a href="https://machingclee.github.io/blog/Nextjs-with-Electron">this article</a>, then it is natural to wish the floating TOC can highlight and **_scroll to that title_** automatically.
