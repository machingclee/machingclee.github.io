...
### Purpose of This Project and the Results

<item>

**Purpose of The Chatbot.** This project is to create a chatbot to 

> Search my tech articles *using natural languages* 

because of the following problem when there are plenty of articles:

- I forget the title of the article, or 
- The fuzzy text search fails:
...
**Chatbot Result.**  You can chat to my blog explorer which is available at the lower right corner of this webpage:

![](/assets/img/2026-03-20-02-12-47.png)

You can ask any technical question, my chatbot will try to find the most relevant articles for you with a brief summary how your problem could be solved:

![](/assets/img/2026-03-19-05-05-21.png?width=500px)

And the relevant articles follow:

![](/assets/img/2026-03-22-01-14-16.png)
...
- `string_to_array(metadata->>'tags', ',')` resolves into a ***text array***;
  ...
  `metadata->>'tags'` is `'tag1,tag2,tag3'`.
...
- `%s::text[]` resolves into **`ARRAY['tag1', 'tag2', 'tag3']::text[]`**;
  ...
  Our query paramter `tags` is of type `list[str]`, `cur.execute` from `psycopg2` converts it into `ARRAY[...]` 
  </item>
