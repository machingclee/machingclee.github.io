...
var chainCollection = mongodb.getCollection(CollectionNames.ns_email_messages_refined);
var pipeline = MongoDB.createJsonPipeline();
pipeline
    .add(String.format("[{ $match:{ email_chain_oid: \"%s\" }}]", chainOid))
    .addLeftJoin(CollectionNames.ns_users,
            "sender_email",
            "user_name",
    ...
    .addLeftJoin(CollectionNames.ns_users,
            ...
            "recipientsInDb")
    .addLeftJoin(CollectionNames.ns_companies,
