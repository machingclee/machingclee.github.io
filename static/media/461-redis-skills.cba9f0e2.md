---
title: "Practical use of Redis List and Stream"
date: 2026-02-21
id: blog0461
tag: redis
toc: true
...
let redis create auto-generated ID for us

ID is composed of two parts, one is timetamp in millisecond and one is ordering started from 0

### Radix Tree

suitable to store data that have the same prefix
