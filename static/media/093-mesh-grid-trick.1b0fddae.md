...
id: blog093
tag: deep-learning
intro: In practice we can directly use `torchvision.models.swin_t` to use pretrained model. As if the case of `ResNet` we may want at least implement it once to understand the structure.
