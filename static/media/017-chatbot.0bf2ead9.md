...
I intensionally keep private the repository of how I create the embeddings, but the underlying idea has been outlined in [#chunking_strategy].
...
and then we can search using this expanded list of tags.
