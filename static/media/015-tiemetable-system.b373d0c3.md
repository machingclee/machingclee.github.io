...
**Remark 2.** Due to performance consideration everything inside `entityManager.escapeFromDirtyCheck` has been deleted from persitent context, therefore data are not persisted via dirty check. 
