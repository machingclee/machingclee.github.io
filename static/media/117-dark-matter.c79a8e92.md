...
intro: Record the usage of dark-matter.
---
...
- `111`, a plain number, will be converted to number
- `false`, and true will be converted to boolean
- `2022-01-01` will be converted to Date object
