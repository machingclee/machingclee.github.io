...
- **libtorch.** We can still download pre-built libtorch library in official pytorch website. The cmake instruction remains the same as windows.

- **OpenCV.** We install opencv directly by homebrew:
