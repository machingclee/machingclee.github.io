---
title: "Semantic Chunking and Agentic Rephase and Reranking"
date: 2025-12-16
id: blog0443
...
We `uv init` and `uv sync` with the following `pyproject.toml`. We can exclude them whenever we want.
...
### Prompts to answer question with Reranked RAG
#### `rewrite_query`
