...
\end{align*}
$$
$\mathcal L_\mathrm{id}$ is called ***identitiy loss***, $\mathcal L_{\mathrm{cycle}}$ is called ***cycle loss***  and $\mathcal L_{g\text{-}d}$ is called **generator's discriminator loss**.
