...
- [link](https://tuufless.github.io/FFXIV-Elemental-Raid-Macros/ultimates/dsr/)
...
- 第一次 MT 吃三連劈只開小減，ST 也交小減。溝通是否要此刻換坦。
- 交叉接線，MT, ST 開 20% or 30%，
- 接線後 MT 吃 heel，換坦，ST 20% or 30% 接三連
- 優先順時針交換
- 以下以 ST 為例：
  - **ST 有隕石.** 原地南邊
  - **ST 沒有隕石.**
...
**_相同 symbol_** (數字不同) 貼貼，鎖鏈跟鎖鏈，禁止跟禁止。
