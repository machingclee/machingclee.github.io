...
A couldn't fetch problem may be due to invalid or incorrect format of our \`sitemap.xml\`, to check its validity, try:

- https://www.xml-sitemaps.com/validate-xml-sitemap.html

![](/assets/img/2026-05-10-19-53-32.png)

##### More Comprehensive Rules that we Should Check

There is a more comprehensive rules written in Chinese:

- [Google Search Console 的 sitemap 提示【无法获取】or【无法读取站点地图】](https://support.google.com/webmasters/community-guide/303086556?hl=zh-Hans)

for more rules to follow. We may ask AI to obey all these to ensure our \`xml\` file is valid.




### Ask Google to Actively Crawl my Webpage via URL Inspection Tool

Now our page might be developed for years and googlebot may not prioritize our page to be crawled, we may ask for google to reprioritize for earlier discovery of our \`sitemap.xml\`.

#### Step 1. Write \`robots.txt\`

Before using the URL Inspection Tool, make sure a \`robots.txt\` file is placed at the root of our site. This file tells crawlers which pages they are allowed to access and where the sitemap is located.

The following is the \`robots.txt\` used in this project:
...
Sitemap: https://machingclee.github.io/sitemap_new.xml
\`\`\`

- \`User-agent: *\` applies the rules to all crawlers.
- \`Disallow:\` with no path means all pages are allowed to be crawled.
- \`Sitemap:\` tells Google exactly where to find your sitemap.

For a Vite / CRA project, place this file in the \`public/\` folder so it is served at the site root as \`/robots.txt\`.

#### Step 2. Use the URL Inspection Tool

First login into google search console, we can discover a URL inspection tool at the top:

![](/assets/img/2026-05-10-01-24-51.png)


Now simply input the address of the entrypoint of our webpage, it will say that our webpage is not served by google, then we can ask for creating index:

![](/assets/img/2026-05-10-01-30-19.png)


After our request has been made, it will say that our request has been submitted:

![](/assets/img/2026-05-10-01-26-56.png)
