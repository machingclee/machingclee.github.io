...
We have covered the details of the client-side connection initiation in a previous article. The client initiates a connection via the \`connect\` system call, which eventually reaches \`tcp_v4_connect\`:
