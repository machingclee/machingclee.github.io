...
Redis simply embeds \`0.7213...\` as a hardcoded constant in its [C source code](https://github.com/redis/redis/blob/unstable/src/hyperloglog.c#L404):
...
- [**[PEOF]** Philippe Flajolet, Éric Fusy, Olivier Gandouet, Frédéric Meunier, *HyperLogLog: the analysis of a near-optimal cardinality estimation algorithm*, DMTCS Proceedings, 2007](https://algo.inria.fr/flajolet/Publications/FlFuGaMe07.pdf)`;export{e as default};
