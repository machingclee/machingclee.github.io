...
當時的 Tech Lead 偏愛 MongoDB，而因為他即將離去所以選擇我當時熟悉的 Tech Stack。為了開發效率我們嘗試 Express + MongoDB (最終變成 Spring Boot + PostgreSQL，這又是另一個故事了)。工作這幾年都由比我更 senior 的人來 ***從零*** 建立後端，這方面我沒甚麼 hands-on 經驗，也只好邊學邊做。
...
I-Charge 如其說是一個 offer，他更像是一個 rejection。

我薪金已經一年半沒有週整過，其實我薪金加幅寫了 HKD 5000，是留一個空間讓對方壓價，你但凡加個 HKD 3000 到 HKD 4000 我都會立刻接受，畢竟我真的很想轉環境。I-Charge 出 offer 的時候直接把加幅壓到只剩 HKD 1000。收到電話通知後從有 offer 到 reject offer 整個過程不到 1 分鐘，有緣無份 (\`・ω・´)。
